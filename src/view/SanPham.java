...
//        cboTenSp.setSelectedItem(tblSanPhamChiTiet.getValueAt(row, 0));
    ...
    // Kiểm tra nếu tên thuộc tính là số âm hoặc số đứng đầu
//    if (ten.matches("^-\\d.*|\\D.*")) {
//        JOptionPane.showMessageDialog(this, "Tên thuộc tính không được là số âm hoặc số đứng đầu.");
//        return;
//    }

    // Tiếp tục thêm thuộc tính vào cơ sở dữ liệu tùy thuộc vào loại thuộc tính được chọn
    ...
    txtThem.setText(""); // Xóa nội dung trong ô nhập liệu sau khi thêm
}
