...
public class BanHang extends javax.swing.JPanel {
    ...
    private void loadCategoryThuongHieu() {
        ...
        if (!listKhuyenMai.isEmpty()) {
            for (KhuyenMai khuyenMai : listKhuyenMai) {
                cbx_khuyenMai.addItem(khuyenMai.getCodeKhuyenMai());
            }
    ...
    private boolean thanhToan() {
        ...
        try {
            ...
            for (KhuyenMai khuyenMai : listKhuyenMai) {
                if (khuyenMai.getCodeKhuyenMai().equals(inputKhuyenMai)) {
    ...
    private void updateSoLuongVoucher() {
        ...
        for (KhuyenMai khuyenMai : listKhuyenMai) {
            if (khuyenMai.getCodeKhuyenMai().equalsIgnoreCase(voucher)) {
    ...
    private void applyKhuyenMai() {
        ...
        if (!isAvaliable) {
            JOptionPane.showMessageDialog(this, "Voucher không chính xác hoặc đã hết!");
            return;
        }
    }
    ...
    private void initComponents() {
        ...
        lbl_sdtKH.setText("...");
        jPanel1.add(lbl_sdtKH, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 120, 160, -1));
        ...
        cbx_khuyenMai.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "All" }));
        ...
        add(btnThemSpVaoHD, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 370, 120, 40));
...
//                        System.out.println("123");
    ...
    private void cbx_khuyenMaiItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbx_khuyenMaiItemStateChanged
        if (!(cbx_khuyenMai.getSelectedItem() + "").equalsIgnoreCase("All")) {
            applyKhuyenMai();
        }else {
            lbl_giamVoucher.setText("");
            try {
