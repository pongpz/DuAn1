...
public class HoaDonChiTiet extends javax.swing.JPanel {
    ...
    HoaDonServiceImpl sv = new HoaDonServiceImpl();
    ...
    private void initComponents() {
        ...
        tblHoaDon.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "IDKH", "IDNV", "Mã hóa đơn", "Tình trạng", "Ngày thanh toán", "Tổng tiền", "Ghi chú"
            }
        ));
...
//        
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        for (int i = 0; i < sv.getAll().size(); i++) {
            if (nameSearch.equals(sv.getAll().get(i).getMa())) {
                HoaDon ls = sv.getAll().get(i);
                hd.add(ls);
            }
        }
        showData(hd);
